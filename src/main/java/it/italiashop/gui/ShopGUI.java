...
public class ShopGUI {
    ...
    public void openCategoryMenu(Player player) {
        Inventory inv = Bukkit.createInventory(null, 27, ChatColor.GREEN + "Compra - Categoria");

        inv.setItem(10, createItemWithLore(Material.DIRT, ChatColor.YELLOW + "Blocchi", Collections.singletonList(ChatColor.GRAY + "Terra, Pietra, Legno...")));
        inv.setItem(11, createItemWithLore(Material.DIAMOND, ChatColor.AQUA + "Minerali", Collections.singletonList(ChatColor.GRAY + "Ferro, Oro, Diamante...")));
        inv.setItem(12, createItemWithLore(Material.OAK_LEAVES, ChatColor.GREEN + "Natura", Collections.singletonList(ChatColor.GRAY + "Alghe, Fiori, Piante...")));
        inv.setItem(13, createItemWithLore(Material.NETHERRACK, ChatColor.RED + "Nether", Collections.singletonList(ChatColor.GRAY + "Blaze, Ghast, Nether...")));
        inv.setItem(14, createItemWithLore(Material.END_STONE, ChatColor.LIGHT_PURPLE + "End", Collections.singletonList(ChatColor.GRAY + "Ender, Chorus, Shulker...")));
        inv.setItem(15, createItemWithLore(Material.TOTEM_OF_UNDYING, ChatColor.GOLD + "Rari", Collections.singletonList(ChatColor.GRAY + "Totem, Elitra...")));
