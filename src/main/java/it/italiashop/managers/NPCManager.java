...
public class NPCManager {
    ...
    public void save() {
        ...
        if (shopLocation != null) {
            ...
            config.set("shop.yaw", shopLocation.getYaw());
        }
        ...
        if (config.contains("shop")) {
            ...
            if (w != null) {
                shopLocation = new Location(w,
                        config.getDouble("shop.x"),
                        config.getDouble("shop.y"),
                        config.getDouble("shop.z"),
        ...
        if (config.contains("pvp")) {
            ...
            if (w != null) {
                pvpLocation = new Location(w,
                        config.getDouble("pvp.x"),
                        config.getDouble("pvp.y"),
                        config.getDouble("pvp.z"),
